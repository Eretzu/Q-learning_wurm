...
public:
  // Constructor
  QLearning(short int joints, short int precision, std::string name, double alpha, double gamma, bool info, bool cpuInfo, 
  long int& step, int frequency = 1000, bool collective = false);
  // Destructor
  ~QLearning();
